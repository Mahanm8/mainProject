...
using main.BLL;
using static main.BLL.usermanager;
            ...
            else
            {
                ...
                if (resultPage.Item1 != "AdminPage.aspx")
                {
                    ...
                    else
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('شما قبلا ثبت نام کرده اید و با موفقیت وارد شدید');window.location ='paneladmin.aspx';", true);
